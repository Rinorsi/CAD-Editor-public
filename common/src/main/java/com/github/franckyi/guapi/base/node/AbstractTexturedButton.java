...
public abstract class AbstractTexturedButton extends AbstractImageView implements TexturedButton {
    ...
    public AbstractTexturedButton(Identifier textureId, boolean drawButton) {
        super(textureId);
        setDrawButton(drawButton);
    }

    public AbstractTexturedButton(Identifier textureId, int imageWidth, int imageHeight, boolean drawButton) {
