...
public class SyntaxHighlightingTextArea extends TextAreaImpl {
    ...
    private final ObjectProperty<Integer> parseErrorIndexProperty = ObjectProperty.create(null);
    ...
    public void setParseErrorIndex(Integer index) {
        parseErrorIndexProperty().setValue(index);
    }

    public Integer getParseErrorIndex() {
        Integer value = parseErrorIndexProperty().getValue();
