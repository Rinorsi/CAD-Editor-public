...
public abstract class EntryModel implements Model {
    ...
    public enum Type {
        ...
        ENCHANTMENT, HIDE_FLAG, ATTRIBUTE_MODIFIER, SELECTION, SELECTION_POTION, POTION_EFFECT, FOOD_EFFECT, ARMOR_COLOR,
        VAULT_ITEM, VAULT_ENTITY, ENTITY_EQUIPMENT, CONTAINER_SLOT, TOOL_RULE, MAP_DECORATION, FOOD_USING_CONVERTS_TO
    }
}
