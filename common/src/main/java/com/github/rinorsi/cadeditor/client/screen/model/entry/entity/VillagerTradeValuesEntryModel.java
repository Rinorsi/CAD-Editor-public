...
public class VillagerTradeValuesEntryModel extends EntryModel {
    private final VillagerTradeEntryModel tradeModel;

    public VillagerTradeValuesEntryModel(VillagerTradeEntryModel tradeModel) {
    ...
    @Override
    public Type getType() {
        return Type.VILLAGER_TRADE_VALUES;
    }
}
