...
public class ModTextures {
    ...
    public static final ResourceLocation UPDATE_LOG = LIST_TAG_ADD;
    ...
    public static final ResourceLocation FORMAT = gui("format");

    public static ResourceLocation gui(String textureName) {
        return ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, String.format("textures/gui/%s.png", textureName));
    }
}
